...
<div class="bookings-wrapper mt-4">
    <div class="row col-md-12 col-sm-12 mb-4">
        <h3 class="text-uppercase font-weight-normal mt-2 mr-4">Booking Management</h3>
    </div>
...
<div class="modal fade" id="delete-booking-modal" tabindex="-1" role="dialog" aria-labelledby="delete-booking-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 550px">
        <div class="modal-content n-b-r text-dark">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bolder" id="delete-booking-modal-header-title">Delete Booking</h5>
                ...
                <div class="row mt-4 mb-4 pl-4 pr-4">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group">
                            <label class="">Are you sure you want to delete this booking?</label>
                            <label class="">You can't recovery this booking data after deleted.</label>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger btn-w-bigger text-uppercase" id="btn-delete-booking-confirm">Yes</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="edit-booking-modal" tabindex="-1" role="dialog" aria-labelledby="edit-booking-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content n-b-r text-dark">
            ...
            <div class="modal-body">
                <form id="edit-booking-form" method="post">
                    ...
                    <div class="row mt-2 mb-2 pl-4 pr-4">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="user_name" class="font-weight-bolder">Student</label>
                                <input class="form-control n-b-r"
                                        type="text"
                                        id="user_name"
                                        name="user_name"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control n-b-r">
                                    <option value="0">In Booking</option>
                                    <option value="1">Approved/Booked</option>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-modal-close btn-w-normal" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-success btn-w-normal text-uppercase" id="btn-update-booking">Save</button>
            </div>
        </div>
    </div>
</div>
